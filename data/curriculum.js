...
A kérdések után adj egy komplett fa-szerkezetű mapparendszert maximum 3 szint mélyen, minden fő mappához egy mondatos indoklást, hogy miért van ott. A végén kérdezd meg: melyik részt módosítsam, vagy elindulhatunk?`
      },
      {
        ...
        example: "Hozz létre egy \"Vállalkozás\" projektet. Custom instructions: <em>\"Eszter vagyok, X tevékenységgel foglalkozom Spanyolországban. Mindig magyarul válaszolj, barátságos hangnemben, rövid mondatokban. Ha valami nem tiszta, kérdezz vissza.\"</em> Ezentúl minden beszélgetés ebben a projektben automatikusan tudja mindezt.",
...
Utána készíts egy SVG kódot. Mutasd meg az előnézetet. Ha nem tetszik, dolgozzunk együtt a módosításokon. A végén add meg a kész kódot, amit egy .svg fájlba mentek.`
      },
      {
        ...
        example: "Példa CLAUDE.md részlet: <br><code>Eszter vagyok, Spanyolországban élek, X-szel foglalkozom. Mindig magyarul válaszolj. Ne kezdj 'Remek kérdés!'-sel. Rövid mondatokban dolgozz. Ha nem vagy biztos, mondd meg. A vállalkozásom neve: [...]</code>",
    ...
    lessons: [
      {
        ...
        example: "Hozd létre az első repódat most: <code>eszter-teszt</code> néven. Tedd bele egy szöveges fájlt <code>README.md</code> néven, ami csak annyit tartalmaz, hogy \"Szia, ez a tesztem\". Publikáld. Menj a github.com-ra, jelentkezz be, és látod — ott van.",
...
Magyarul, kezdőnek érthetően. Használj hasonlatot (pl. mentés Word-ben).`
      },
      {
        ...
        time: 15,
        difficulty: "medium",
        what: "A Cloudflare Pages egy <strong>ingyenes webtárhely</strong>, ami automatikusan élesít mindent, amit GitHub-ra feltöltesz. Push = élesítés. Kapsz egy ingyenes aldomaint (pl. <code>eszter-projekt.pages.dev</code>), amit azonnal megoszthatsz bárkivel.",
...
Magyarul, és a végén mondd el, mit jelent az, hogy 'ingyenes' — hol vannak a korlátok.`
      },
      {
        ...
        how: "1. Cloudflare dashboard → bal menü → <strong>R2</strong> → <strong>Create bucket</strong><br>2. Adj nevet (pl. <code>eszter-media</code>), location: EU<br>3. Kattints a bucket-re → <strong>Settings</strong> → <strong>Public Access</strong> → engedélyezd (ha publikus képek lesznek)<br>4. <strong>Upload</strong> gombbal tölts fel fájlt<br>5. Kattints a fájlra → <strong>Copy URL</strong> → ezt az URL-t használhatod bárhol",
        ...
        example: "Töltsd fel a saját profilképedet R2-be, és kapsz egy olyan linket, mint: <code>https://pub-xxx.r2.dev/eszter.jpg</code>. Ezt beteheted a 'Rólam' oldaladba, Facebook borítóba, emailekbe.",
...
A végén magyarázd el egyszerűen, mikor érdemes R2-t használni és mikor elég csak a repóba rakni a képeket.`
      },
      {
        ...
        time: 10,
        difficulty: "easy",
        what: "A saját domain (pl. <code>eszteroldal.hu</code> vagy <code>eszter.es</code>) egy egyedi webcím, amit megvásárolsz. Addig, amíg nincs, a Cloudflare Pages ingyenes aldomaint ad (<code>projekt.pages.dev</code>) — ez teljesen elég a kezdéshez.",
        ...
        example: "Első körben: <code>eszter-rolam.pages.dev</code> — tökéletes.<br>6 hónap múlva: <code>eszter.com</code> — ha már biztos vagy a brandedben.",
